  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?=form_open('papan-kontrol/pidum', array('id' => 'form', 'role' => 'form'));?>
            <?php
            ...
            <div class="form-group">
                <label>TAHAP I</label>
                <?=form_input('tahap_1', '', array('class' => 'form-control datepicker', 'id' => 'input-tahap_1'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
                <div class = "row">
            ...
            <div class="form-group">
                ...
                <?=form_input('tahap_2', '', array('class' => 'form-control datepicker', 'id' => 'input-tahap_2'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
                <label>LIMPAH PN</label>
                <?=form_input('limpah_pn', '', array('class' => 'form-control datepicker', 'id' => 'input-limpah_pn'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
                <label>PUTUS PN</label>
                <?=form_input('putus_pn', '', array('class' => 'form-control datepicker', 'id' => 'input-putus_pn'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
                <label>BANDING</label>
                <?=form_input('banding_pn', '', array('class' => 'form-control datepicker', 'id' => 'input-banding_pn'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
                <label>KASASI</label>
                <?=form_input('kasasi_pn', '', array('class' => 'form-control datepicker', 'id' => 'input-kasasi_pn'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
                <label>EKSEKUSI</label>
                <?=form_input('eksekusi_pn', '', array('class' => 'form-control datepicker', 'id' => 'input-eksekusi_pn'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
                <label>GRASI</label>
                <?=form_input('grasi_pn', '', array('class' => 'form-control datepicker', 'id' => 'input-grasi_pn'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
                <label>PK</label>
                <?=form_input('pk_pn', '', array('class' => 'form-control datepicker', 'id' => 'input-pk_pn'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
                <label>PEKATING</label>
                <?=form_input('pekating_pn', '', array('class' => 'form-control datepicker', 'id' => 'input-pekating_pn'));?>
                <div id="error"></div>
            </div>
            <div class="form-group">
